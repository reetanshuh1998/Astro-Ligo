...
### How to Reproduce Figures 1–5
Upon successful execution, the script automatically compiles a dedicated suite of five premium publication-grade reporting plots under `outputs/figures/`:
...
3. **`03_uncertainty_calibration.png` (Figure 3: Calibration Diagnostic)**:
   - **Method**: Computes Probability Integral Transform (PIT) value histograms and plots the expected vs. actual empirical confidence interval coverage.
